		...
		<div id="congrats" className="tabContent">
			<div className="congrats__container">
				<div className="congrats__image">
					<figure>
						<img src="/images/congrats-card.png" width="103" height="72.32" alt="Primer bank logo" srcSet="" />
					</figure>
				</div>
				<div className="congrats__content">
					...
					<p className="congrats__caption">Now pay later at ease with your Primer Pay in Bits</p>
				</div>
			</div>
			<div className="download__container">
				<div className="download__heading">Download the primer app</div>
				<div className="download__content">
					<div className="download__image">
						<figure>
							<img src="/images/coins.png" width="69.88" height="58.19" alt="Primer bank logo" srcSet="" />
						</figure>
					</div>
					<div className="download__caption">
						Check your credit limit and have <br />
						access to all the Primer services.
					</div>
				</div>
			</div>
